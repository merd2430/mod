...
module.exports.run = async (client, message, args) => {
    ...
    setTimeout(async () =>{
    kişi.roles.remove(ayarlar.Cezalı)
    }, ms(zaman));
    setTimeout(async () =>{
