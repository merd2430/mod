...
const lore = Number(args[0])
if (lore > members.length) {
...
message.channel.send(new Discord.MessageEmbed().setDescription("<@"+members[lore - 1].user.id+"> üyesi sunucunun "+args[0]+". üyesi."))
}
