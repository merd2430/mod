...
.setColor("#7289D")
.setDescription(`${kullanıcı}, ${message.author} \`${kullanıcı.voice.channel.name}\` Odasına Gelmek İstiyor. Kabul Ediyor musun?`)
.setFooter(`Lore ❤️`)
...
exports.conf = { enabled: true, guildOnly: true, aliases: ["git"], permLevel: 0, }
